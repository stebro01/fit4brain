...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'trainingsplan_b', 'name': 'Trainingsplan_control', component: () => import('src/pages/Trainingsplan_control.vue'), beforeEnter: beforeEnterFunc },
      { path: 'trainingsplan_a', 'name': 'Trainingsplan_verum', component: () => import('src/pages/Trainingsplan_verum.vue'), beforeEnter: beforeEnterFunc },
      { path: 'about_b', 'name': 'about_control', component: () => import('src/pages/About_control.vue'), beforeEnter: beforeEnterFunc },
      { path: 'about_a', 'name': 'about_verum', component: () => import('src/pages/About_verum.vue'), beforeEnter: beforeEnterFunc }
    ]
  },
